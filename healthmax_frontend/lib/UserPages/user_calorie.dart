...
class _UserCaloriePageState extends State<UserCaloriePage> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Data synced successfully!"), backgroundColor: Colors.green, behavior: SnackBarBehavior.floating),
        );
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Failed to sync data."), backgroundColor: Colors.redAccent, behavior: SnackBarBehavior.floating),
        );
      }
    } finally {
    ...
    return Scaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                        FittedBox(
                          ...
                          child: Text(
                            themeProvider.translate('calorie_intake').replaceFirst(' ', '\n'),
                            style: const TextStyle(
                              fontSize: 42,
                              fontWeight: FontWeight.w900,
                              color: Colors.white,
                          ...
                          child: Column(
                            children: [
                              Text(
                                ...
                                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: textPrimary, fontFamily: "LexendExaNormal"),
                              ),
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: _buildClickableStat(
                                      ...
                                      onTap: () => _showEatenBreakdown(calorieData, isDark, surfaceColor, textPrimary, textSecondary, dividerColor, themeProvider),
                                    ),
                                  ),
                                  Expanded(
                                    flex: 4,
                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          ...
                                          TweenAnimationBuilder(
                                            tween: Tween<double>(
                                              begin: 0,
                                              end: (calorieData.totalEaten / calorieData.targetCalories).clamp(0.0, 1.0),
                                            ),
                                            ...
                                            children: [
                                              FittedBox(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: textPrimary, fontFamily: "LexendExaNormal", letterSpacing: -1),
                                                ),
                                              ),
                                              FittedBox(
                                                fit: BoxFit.scaleDown,
                                                child: Text(
                                                  themeProvider.translate('kcal_left'),
                                  ...
                                  Expanded(
                                    ...
                                    child: _buildClickableStat(
                                      ...
                                      textPrimary: textPrimary, textSecondary: textSecondary,
                                      onTap: () => _showBurnedBreakdown(calorieData, isDark, surfaceColor, textPrimary, textSecondary, dividerColor, themeProvider),
                                    ),
                                  ),
                                ],
                              ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    FittedBox(
                                      fit: BoxFit.scaleDown,
                                      child: Text(themeProvider.translate('intake_breakdown'), style: TextStyle(fontSize: 13, fontWeight: FontWeight.w900, color: textPrimary, fontFamily: "LexendExaNormal")),
                                    ),
                                    const SizedBox(height: 25),
                                    SizedBox(
                                      height: 140,
                                      child: PieChart(
                                        PieChartData(
                                          sectionsSpace: 0, centerSpaceRadius: 30, startDegreeOffset: 270,
                                          sections: _getMacroSections(calorieData),
                                        ),
                                      ),
                                    ),
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            _buildLegendItem(carbColor, themeProvider.translate('carbohydrates'), textPrimary),
                                            _buildLegendItem(proteinColor, themeProvider.translate('protein'), textPrimary),
                                            _buildLegendItem(fatColor, themeProvider.translate('fats'), textPrimary),
                                          ],
                                        ),
                                      ),
                                    ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Center(
                                      child: FittedBox(
                                        fit: BoxFit.scaleDown,
                                        child: Text(themeProvider.translate('summary'), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900, color: textPrimary, fontFamily: "LexendExaNormal")),
                                      ),
                                    ),
                                    const SizedBox(height: 25),
                                    _buildSummaryMacro(themeProvider.translate('carbohydrates'), calorieData.totalCarbs.toInt(), calorieData.targetCarbs, textPrimary, textSecondary, themeProvider),
                                    const SizedBox(height: 20),
                                    _buildSummaryMacro(themeProvider.translate('protein'), calorieData.totalProtein.toInt(), calorieData.targetProtein, textPrimary, textSecondary, themeProvider),
                                    const SizedBox(height: 20),
                                    _buildSummaryMacro(themeProvider.translate('fats'), calorieData.totalFats.toInt(), calorieData.targetFats, textPrimary, textSecondary, themeProvider),
                                  ],
                                ),
                              ),
                            ),
      ...
      floatingActionButton: Padding(
        ...
        child: FloatingActionButton.extended(
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const UserLogFoodPage())),
          backgroundColor: themeBlue, elevation: 8,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
          label: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: Text(themeProvider.translate('log_food'), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16, fontFamily: "LexendExaNormal")),
          ),
        ),
      ),
  ...
  Widget _buildClickableStat({required String label, required int value, required Color textPrimary, required Color textSecondary, required VoidCallback onTap}) {
    return Material(
      ...
      child: InkWell(
        onTap: onTap, borderRadius: BorderRadius.circular(15), splashColor: themeBlue.withValues(alpha: 0.1), highlightColor: themeBlue.withValues(alpha: 0.05),
        child: Padding(
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Flexible(child: FittedBox(fit: BoxFit.scaleDown, child: Text(label, style: TextStyle(fontWeight: FontWeight.bold, color: textSecondary, fontSize: 13)))),
                  const SizedBox(width: 4), Icon(Icons.info_outline_rounded, size: 14, color: textSecondary.withValues(alpha: 0.5)),
                ],
              ),
              const SizedBox(height: 5),
              FittedBox(fit: BoxFit.scaleDown, child: Text("$value", style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: textPrimary, fontFamily: "LexendExaNormal"))),
  ...
  void _showEatenBreakdown(CalorieProvider data, bool isDark, Color surfaceColor, Color textPrimary, Color textSecondary, Color dividerColor, ThemeProvider theme) {
    showModalBottomSheet(
      ...
      builder: (context) => _buildBottomSheetLayout(
        title: theme.translate('eaten'), isDark: isDark, surfaceColor: surfaceColor, textPrimary: textPrimary, dividerColor: dividerColor, themeProvider: theme,
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            if (data.calorieHistory.isEmpty)
              Padding(padding: const EdgeInsets.symmetric(vertical: 30), child: Text("No meals logged today.", style: TextStyle(color: textSecondary, fontWeight: FontWeight.bold)))
            else
  ...
  void _showBurnedBreakdown(CalorieProvider data, bool isDark, Color surfaceColor, Color textPrimary, Color textSecondary, Color dividerColor, ThemeProvider theme) {
    showModalBottomSheet(
      context: context, backgroundColor: Colors.transparent, isScrollControlled: true,
      builder: (context) => _buildBottomSheetLayout(
        title: theme.translate('burned'), isDark: isDark, surfaceColor: surfaceColor, textPrimary: textPrimary, dividerColor: dividerColor, themeProvider: theme,
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            if (data.currentSteps == 0 && data.workoutCalories == 0)
              Padding(padding: const EdgeInsets.symmetric(vertical: 30), child: Text("No activity recorded yet.", style: TextStyle(color: textSecondary, fontWeight: FontWeight.bold)))
            else ...[
                    ...
                    children: [
                      Expanded(
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Icon(Icons.directions_walk_rounded, color: Color(0xFFFF9F43), size: 18), const SizedBox(width: 10), 
                    ...
                    children: [
                      Expanded(
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Icon(Icons.fitness_center_rounded, color: Color(0xFF2ED573), size: 18), const SizedBox(width: 10), 
  ...
  Widget _buildBottomSheetLayout({required String title, required Widget content, required bool isDark, required Color surfaceColor, required Color textPrimary, required Color dividerColor, required ThemeProvider themeProvider}) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(title, style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, fontFamily: "LexendExaNormal", color: textPrimary)), const SizedBox(height: 20),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 10),
          Flexible(child: FittedBox(fit: BoxFit.scaleDown, child: Text(label, style: TextStyle(fontSize: 12, color: textPrimary, fontWeight: FontWeight.w600)))),
        ],
      ),
    );
  }

  Widget _buildSummaryMacro(String label, int current, int target, Color textPrimary, Color textSecondary, ThemeProvider theme) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        FittedBox(fit: BoxFit.scaleDown, child: Text("$label :", style: TextStyle(fontSize: 12, color: textPrimary, fontWeight: FontWeight.bold))),
        ...
        FittedBox(
          ...
          child: RichText(
            text: TextSpan(
              children: [
                TextSpan(text: "$current g", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: textPrimary)),
                TextSpan(text: " / $remaining g ${theme.translate('remaining')}", style: TextStyle(fontSize: 10, color: textSecondary)),
              ],
            ),
          ),
        ),
